...
- admit a reattach identity before publishing renderer PTY handlers; a stale transport drops every owned handler without killing the durable PTY a current lease may adopt;
